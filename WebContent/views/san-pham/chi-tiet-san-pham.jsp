            ...
            <div class="p-2" style="margin-left: 20px;">
                ...
                <div class="invoice-details p-3 border rounded mt-5" style="background-color: #F5F5F5;">
                    <form>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="img/fenix/7progray.jpg" alt="Product Image" class="product-image"
                                    width="200px" height="200px">
                            </div>
                            <div class="col-sm-9">
                                <div class="row mb-3 mb-4 align-items-center">
                                    <div class="col-sm-2">
                                        <label for="maHoaDon" class="form-label">Mã sản phẩm</label>
                                    </div>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3 mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <label for="number" class="form-label">Mã phân loại</label>
                                            </div>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <label for="quantity2" class="form-label">Giá niêm yết</label>
                                            </div>
                                            <div class="col-sm-8">
                    ...
                    <div class="text-end mt-3">
                        <button id="previousBtn" class="btn custom2-btn">
                            << </button>
